...
variable "security_control_overrides" {
  description = <<-EOT
    ...
    Example use cases:
    - disable_deletion_protection: Development/testing user pools
    - disable_advanced_security: Cost optimization for non-production environments
    - disable_mfa_requirement: Demo environments with simplified authentication
